...
public class SettingsDto {
    public static final String SMS_PROPERTIES_FILE_NAME = "motech-sms.properties";
    ...
    public static final String MAIL_LOG_PURGE_TIME_MULTIPLIER_PROPERTY = "sms.log.purgetimemultiplier";
    ...
    public SettingsDto(SettingsFacade settingsFacade) {
        this(
                ...
                settingsFacade.getProperty(MAIL_LOG_PURGE_TIME_MULTIPLIER_PROPERTY, SMS_PROPERTIES_FILE_NAME)
        );
    }
