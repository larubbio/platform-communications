...
public class KookooIvrServiceBundleIT extends BaseOsgiIT {
    ...
    @Ignore
    public void ignore_testKooKooCallbackUrlIsNotAuthenticated() throws IOException, InterruptedException, InvalidSyntaxException {
        checkSecurity();
    ...
    @Ignore
    public void ignore_testKooKooStatusCallbackUrlIsNotAuthenticated() throws IOException, InterruptedException, InvalidSyntaxException {
        checkSecurity();
            ...
            for (ServiceReference ref : bundleContext.getAllServiceReferences(WebApplicationContext.class.getName() , null)) {
                if (ref.getBundle().getSymbolicName().equals("org.motechproject.motech-platform-web-security")) {
                    ...
                    if (rules != null && !rules.isEmpty()) {
                        ...
                        System.out.println("Kookoo security rule unavailable");
                    }
                }
            }
